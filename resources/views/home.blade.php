@extends('layouts.template')
    ...
    <div class="row align-items-center py-4"> <h1 class="text-center red pb-5 pt-4 py-2"> Hottest Items </h1> 
        <div class="row ps-all-products">
            @foreach ($products as $key => $product)
                @if ($key < 3)
                <div class="col align-items-start">
                    <a href="detailProducts/{{$product['id']}}"><img src="{{asset($product->foto)}}" alt="Banner 1" width="280" height="420" class = "shadow-lg"> </a>
                    <div class="row align-items-center">
                        <div class="col">
